        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(hipotenusa.contains("?")){
                ...
                if (!cateto1.contains("?") && !cateto2.contains("?")) {
                    ...
                    if (c > h) {
                        mensagem = "O cateto nao pode ser maior que a hipotenusa";
                        resultado = Double.NaN;
                    } else {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Pitagoras Servlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1> Resultado - Pitagoras</h1>");
            out.println("<hr>");
            out.println("Hipotenusa:" + hipotenusa);
            out.println("<br>");
            out.println("Cateto1: " + cateto1 + "<br>" );
            out.println("Cateto2: " + cateto2 + "<br>" );
            if (mensagem.isEmpty()) {
