...
class API {
  static String authToken = "123"; //muito dificil!!!!

  static Future getUsers() async {
    return await http.post(
      Uri.parse("http://emsapi.esy.es/todolist/api/user/search/"),
  ...
  static Future getTasks() async {
    return await http.post(
      Uri.parse("http://emsapi.esy.es/todolist/api/task/search/"),
      headers: <String, String>{
        "Content-Type": "Application/json; charset=UTF-8",
        "Authorization": authToken,
      },
  ...
  static Future newTask(String taskName) async {
    return await http.post(
        Uri.parse("http://emsapi.esy.es/todolist/api/task/new/"),
        headers: <String, String>{
          "Content-Type": "Application/json; charset=UTF-8",
          "Authorization": authToken,
        },
  ...
  static Future updateUser(String userName, String userPass) async {
    return await http.post(
        Uri.parse("http://emsapi.esy.es/todolist/api/user/update/"),
        headers: <String, String>{
          "Content-Type": "Application/json; charset=UTF-8",
          "Authorization": authToken,
        },
        body: jsonEncode(
            <String, Object>{'username': userName, 'password': userPass}));
  }
}
